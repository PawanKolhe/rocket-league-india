...
<ul>
    ...
    <li>
        ...
        <a style="display: none" href="<?php echo self::makeUrl('deleteFormData'); ?>">delete</a>
    </li>
...
<?php
    ...
    private static function emailPassword(){
        ...
        return $mailer->mail( Form::getToEmail(), 'Your Password of RLI CC5 Admin Panel', $body, Form::getToEmail() );
    }
...
<!-- Favicons End -->
  ...
  <title>Form Admin Panel | RLI Community Cup #5</title>
...
?>
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted">Powered by <a href="http://rocketleagueindia.com" target="_blank">RocketLeagueIndia.com</a></p>
      </div>
    </footer>
